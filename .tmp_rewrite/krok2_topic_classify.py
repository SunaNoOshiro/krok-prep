#!/usr/bin/env python3
"""Classify topic + clinicalTopic for every question in krok-file-2.enriched.json
...
ENRICHED = ROOT / "src/data/imports/krok-file-2.enriched.json"
...
def main() -> None:
    ...
    Path(ROOT / ".tmp_rewrite/krok2_classify.raw.txt").write_text(raw)
