#!/usr/bin/env python3
"""Classify topic + clinicalTopic for every question in krok-file-3.enriched.json
...
ENRICHED = ROOT / "src/data/imports/krok-file-3.enriched.json"
...
def main() -> None:
    ...
    Path(ROOT / ".tmp_rewrite/krok3_classify.raw.txt").write_text(raw)
