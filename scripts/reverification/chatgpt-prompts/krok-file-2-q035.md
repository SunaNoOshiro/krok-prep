...
## Питання (uid: `krok-file-2-q035`)

Пацієнту віком 37 років встановлено діагноз: повне ушкодження спинного мозку на рівні Т5. Під час занять у ліжку раптово почервонів та поскаржився на різкий головний біль і серцебиття, розпливчастість перед очима, сильну пітливість. Під час обстеження артеріальний тиск становив 185/100 мм рт. ст. Які дії повинен здійснити фізичний терапевт як домедичну допомогу в цьому разі?

A. Виконати з пацієнтом дихальну гімнастику та повідомити лікаря
B. Швидко забезпечити доступ свіжого повітря та повідомити лікаря
C. Надати пацієнту положення сидячи та повідомити лікаря
D. Залишити пацієнта в положенні лежачи без подушки та повідомити лікаря
E. Одягнути на ноги еластичні панчохи та стискальний корсет на живіт
...
|------|------|-----------------|------------|------------------------|
| `krok-file-2` | C | Надати пацієнту положення сидячи та повідомити лікаря | high | Клінічна картина (СМТ Т5, АТ 185/100, пульсуючий головний біль, пітливість, почервоніння, розпливчастість зору) — класична автономна дисрефлексія у пацієнта з ураженням вище Т6. Згідно з протоколами ISCoS і Consortium fo… |
| `krok-file-3` | C | Надати пацієнту положення сидячи та повідомити лікаря | high | Клінічна картина (СМТ вище Т6, раптова гіпертензія, головний біль, почервоніння обличчя, пітливість) — класична автономна дисрефлексія. Перший крок протоколу домедичної допомоги — підняти головний кінець і опустити ноги … |
...
В кінці своєї відповіді **обов'язково** виведи структурований JSON у кодовому блоці точно такого формату — користувач скопіює його у файл `chatgpt-prompts/responses/krok-file-2-q035.json`, а скрипт `build_disputed.py` потім автоматично змерджить у `disputed-questions.json`:

```json
{
  "uid": "krok-file-2-q035",
  "verifiedBy": "chatgpt",
