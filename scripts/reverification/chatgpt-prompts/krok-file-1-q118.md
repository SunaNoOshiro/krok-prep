...
## Питання (uid: `krok-file-1-q118`)

Чому відповідає одна метаболічна одиниця?

A. Витраті енергії та споживанню кисню, виміряного у спокої, і становить 3,5 л/хв
B. Витраті енергії та споживанню кисню, виміряного під час ходьби зі швидкістю 5 км/год, і становить 3,5 мл/кг/хв
C. Витраті енергії та споживанню кисню, виміряного під час ходьби зі швидкістю 5 км/год, і становить 3,5 л/кг/хв
D. Витраті енергії та споживанню кисню, виміряного у спокої, і становить 3,5 мл/кг/хв
E. Витраті енергії та споживанню кисню, виміряного під час ходьби зі швидкістю 5 км/год, і становить 3,5 л/хв
...
|------|------|-----------------|------------|------------------------|
| `krok-file-1` | D | Витраті енергії та споживанню кисню, виміряного у спокої, і становить 3,5 мл/кг/хв | high | За загальноприйнятим визначенням (ACSM Guidelines, AHA) 1 MET = базальне споживання кисню у спокої сидячи = 3,5 мл O2/кг/хв. Це обов'язково відносна величина, нормована на масу тіла. Варіант a містить правильний референс… |
...
В кінці своєї відповіді **обов'язково** виведи структурований JSON у кодовому блоці точно такого формату — користувач скопіює його у файл `chatgpt-prompts/responses/krok-file-1-q118.json`, а скрипт `build_disputed.py` потім автоматично змерджить у `disputed-questions.json`:

```json
{
  "uid": "krok-file-1-q118",
  "verifiedBy": "chatgpt",
