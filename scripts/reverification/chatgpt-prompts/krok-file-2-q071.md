...
## Питання (uid: `krok-file-2-q071`)

Які функції нижньої кінцівки будуть порушені при розриві двоголового м'яза стегна, що виник у результаті падіння з висоти?

A. Згинання та пронація гомілки
B. Розгинання стегна та гомілки
C. Супінація стопи
D. Згинання стегна та гомілки
E. Розгинання стегна та згинання гомілки
...
|------|------|-----------------|------------|------------------------|
| `krok-file-2` | E | Розгинання стегна та згинання гомілки | high | Двоголовий м'яз стегна — частина hamstrings: длинна головка від сідничного горба розгинає стегно у кульшовому суглобі, а обидві головки згинають гомілку у колінному. Тому при розриві випадають саме розгинання стегна та з… |
| `krok-file-3` | E | Розгинання стегна та згинання гомілки | high | Двоголовий м'яз стегна — біартикулярний м'яз задньої групи. Довга голівка починається від сідничного горба і розгинає стегно в кульшовому суглобі, а обидві голівки разом згинають гомілку в колінному. Отже, при його розри… |
...
В кінці своєї відповіді **обов'язково** виведи структурований JSON у кодовому блоці точно такого формату — користувач скопіює його у файл `chatgpt-prompts/responses/krok-file-2-q071.json`, а скрипт `build_disputed.py` потім автоматично змерджить у `disputed-questions.json`:

```json
{
  "uid": "krok-file-2-q071",
  "verifiedBy": "chatgpt",
