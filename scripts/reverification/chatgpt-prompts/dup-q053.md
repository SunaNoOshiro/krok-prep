...
`cross_file_mismatch, medium_confidence, needs_review_flag`
...
## Питання (uid: `dup-q053`)

Оберіть один зайвий пункт зі шкали повсякденної активності Бартел.

A. Користування туалетом, ходьба по сходах, одягання та купання
B. Приймання їжі, купання, вмивання, одягання по рівній поверхні
C. Приймання їжі, одягання, ходьба по сходах, біг по рівній поверхні
D. Приймання їжі, купання, вмивання, акт дефекації, сечопускання
E. Купання, одягання, користування туалетом, приймання їжі
...
|------|------|-----------------|------------|------------------------|
| `krok-file-2` | C | Приймання їжі, купання, вмивання, акт дефекації, сечовипускання | medium | Питання сформульоване нестандартно («оберіть один зайвий пункт»), але інтерпретується як вибір переліку, що складається виключно з автентичних і неповторюваних категорій Бартел. Варіант (c) — єдиний без структурних дефек… |
| `krok-file-3` | C | Приймання їжі, одягання, ходьба по сходах, біг по рівній поверхні | high | Індекс Бартел оцінює 10 базових ADL: приймання їжі, купання, вмивання/гігієна, одягання, контроль кишечника, контроль сечовипускання, користування туалетом, переміщення з ліжка на крісло, ходьба по рівній поверхні та під… |
...
В кінці своєї відповіді **обов'язково** виведи структурований JSON у кодовому блоці точно такого формату — користувач скопіює його у файл `chatgpt-prompts/responses/dup-q053.json`, а скрипт `build_disputed.py` потім автоматично змерджить у `disputed-questions.json`:
